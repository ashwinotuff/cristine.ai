...
PLANNER_PROMPT = """You are the planning module of Cristine, a personal AI assistant.
...
system_health_agent
  action: "check" | "clean_temp" | "empty_recycle" | "clear_cache" | "disable_startup" | "run_security_scan" (required)
  target: string (optional) — app name for disable_startup, browser name for clear_cache
...
Goal: "Check system health and clean temp files"
Steps:
  1. system_health_agent | action: check
  2. system_health_agent | action: clean_temp
