...
def computer_control(
    ...
    if not ui_automation_allowed(player):
        return (
            "computer_control is disabled in background-safe mode. "
            "Enable Preferences -> Advanced -> 'Allow on-screen automation' to use mouse/keyboard control."
        )
